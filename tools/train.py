...
#parser.add_argument('--rundir', default='./exps/deepmask/train', help='experiments directory')
...
parser.add_argument('--maxepoch', default=300, type=int, metavar='N',
                    help='max number of training epochs')#300
...
parser.add_argument('--print-freq', '-p', default=20, type=int,
                    metavar='N', help='print frequency (default: 20)')#20
